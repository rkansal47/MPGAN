...
eta_boundaries = torch.Tensor([0.4947916567325592, 0.4583333432674408, 0.5052083134651184, 0.5416666865348816, 0.484375,
                                0.4739583432674408, 0.4635416567325592, 0.546875, 0.625, 0.515625, 0.5260416865348816, 
                                0.375, 0.328125, 0.4427083432674408, 0.609375, 0.453125, 0.4166666567325592, 
                                0.4322916567325592, 0.7135416865348816, 0.4010416567325592, 0.6302083134651184, 
                                0.5572916865348816, 0.7083333134651184, 0.6197916865348816, 0.5989583134651184, 
                                0.0416666679084301, 0.421875, 0.0052083334885537624, 0.640625, 0.5885416865348816, 
                                0.5364583134651184, 0.2447916716337204, 0.0989583358168602, 0.109375, 0.578125, 
                                0.2135416716337204, 0.2760416567325592, 0.7916666865348816, 0.390625, 0.3802083432674408, 
                                0.125, 0.5677083134651184, 0.2916666567325592, 0.3489583432674408, 0.359375, 
                                0.5833333134651184, 0.6822916865348816, 0.671875, 0.2552083432674408, 0.4114583432674408, 
                                0.703125, 0.0833333358168602, 0.3072916567325592, 0.3177083432674408, 0.2083333283662796, 
                                0.9583333134651184, 0.3385416567325592, 0.296875, 0.6614583134651184, 0.6510416865348816, 
                                0.2239583283662796, 0.234375, 0.7239583134651184, 0.3697916567325592, 0.2864583432674408, 
                                0.875, 0.265625, 0.75, 0.734375, 0.796875, 0.203125, 0.6927083134651184, 0.171875, 
                                0.1510416716337204, 0.046875, 0.25, 0.7447916865348816, 0.7864583134651184, 0.859375, 
                                0.8177083134651184, 0.9166666865348816, 0.1927083283662796, 0.1197916641831398, 0.140625, 
                                0.078125, 0.0885416641831398, 0.8385416865348816, 0.828125, 0.8072916865348816, 
                                0.0364583320915699, 0.8802083134651184, 0.0572916679084301, 0.0677083358168602, 
                                0.7552083134651184, 0.7760416865348816, 0.8489583134651184, 0.765625, 0.9739583134651184, 
                                0.1822916716337204, 0.1614583283662796, 0.890625, 0.1302083283662796, 0.921875, 
                                0.9010416865348816, 0.8697916865348816, 0.984375, 0.9114583134651184, 0.9322916865348816, 
                                0.9427083134651184, 0.9947916865348816, 0.953125, 0.02604166604578495, 0.015625, 0.9635416865348816])

phi_boundaries = torch.Tensor([0.5, 0.5416666865348816, 0.4583333432674408, 0.2916666567325592, 0.8333333134651184, 
                                0.7916666865348816, 0.375, 0.625, 0.7083333134651184, 0.0416666679084301, 
                                0.1666666716337204, 0.2083333283662796, 0.125, 0.9583333134651184, 0.875])
...
class BucketizeFunction(torch.autograd.Function):
    ...
    def forward(ctx, input):
        eta_bins = torch.bucketize(input[:, :, eta_idx], eta_boundaries.to(input.device))
        phi_bins = torch.bucketize(input[:, :, phi_idx], phi_boundaries.to(input.device))
        ...
        input[:, :, eta_idx] = eta_bins 
        input[:, :, phi_idx] = phi_bins
        return input
