...
class EMDLoss(nn.Module):
    ...
    *Note: PyTorch <= 1.9 has a bug which will cause this to fail for >= 32 particles. This PR should fix this from 1.10 onwards*
    ...
    def __init__(self, method: str = "qpth", num_particles: int = None, qpth_form: str = "L2", qpth_l2_strength: float = 0.0001, device: str = "cpu"):
        ...
        assert method != "cvxpy" or (num_particles is not None and num_particles > 0), "num_particles must be specified to use 'cvxpy' method"
